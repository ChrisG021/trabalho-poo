...
public class FormularioPrincipal extends JFrame {
    ...
    private Integer posicaoInsercao = null;
    ...
    private void salvarAluno() {
        try {
            ...
            if (posicaoInsercao != null) {
                alunoService.inserirAlunoNaPosicao(aluno, posicaoInsercao);

                JOptionPane.showMessageDialog(
                        this,
                        "Inserido com sucesso na posição: " + posicaoInsercao + "!\n" +
                                "Total de aluno: " + alunoService.getQuantidadeAlunos(),
                        "Sucesso na insercao",
        ...
        // JOptionPane.showMessageDialog(
        // this,
        // "Posicao inválida (Lista mudou??): " + e.getMessage() + "\n Tentando
        // adicionar no final",
        // "AVISO",
    ...
    private void inserirNaPosicao() {
        ...
        if (posicaoStr != null && !posicaoStr.trim().isEmpty()) {
            try {
                ...
                int totalAlunos = alunoService.getQuantidadeAlunos();
                if (posicao < 0 || posicao > totalAlunos) {
                    JOptionPane.showMessageDialog(
                            this,
                            "Posição inválida! Deve ser entre 0 e " + totalAlunos + " (final da lista).",
                            "Erro de Posição",
                            JOptionPane.ERROR_MESSAGE);
                    return;
                }
                ...
                int confirmacao = JOptionPane.showConfirmDialog(
                        this,
                        "Posição " + posicao + " confirmada!\n\n" +
                                "Preencha os dados no formulário e clique em 'Salvar Aluno'.",
                        "Confirmação",
                        JOptionPane.YES_NO_OPTION,
                        JOptionPane.INFORMATION_MESSAGE
                        );
                ...
                if (confirmacao == JOptionPane.YES_OPTION) {
                    this.posicaoInsercao = posicao;
                    limparCampos(); 
                    txtMatricula.requestFocus();
                    JOptionPane.showMessageDialog(this, "Modo inserção na posição ativado! Preencha e salve.", "Pronto",
                            JOptionPane.INFORMATION_MESSAGE);
                } else {
                    this.posicaoInsercao = null;
                }

            } catch (NumberFormatException e) {
                JOptionPane.showMessageDialog(
                        this,
                        "Posição inválida! Digite um número inteiro.",
                        "Erro",
                        JOptionPane.ERROR_MESSAGE);
            }
        }
